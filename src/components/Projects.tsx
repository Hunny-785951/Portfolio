...
export default function Projects() {
  useEffect(() => {
    ...
    const handleMouseMove = (e: Event) => {
      ...
      // Smoother rotation values (reduced from 10 to 6)
      const rotateX = ((y - centerY) / centerY) * -6;
      const rotateY = ((x - centerX) / centerX) * 6;

      // Make transform fast for 1:1 tracking, keep other transitions smooth
    ...
    const handleMouseLeave = (e: Event) => {
      ...
      // Restore smooth transition for returning to rest state
      card.style.transition = "transform 0.5s var(--ease-out), border-color 0.3s ease, box-shadow 0.4s ease";
      card.style.transform = "perspective(1000px) translateY(0px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)";
      
      // Clean up inline styles after transition completes to let CSS take over again
      setTimeout(() => {
    ...
    <section id="works">
      <div className="works-inner">
        ...
        <div className="works-grid stagger-children">
          ...
          <div className="work-card">
            <div className="work-thumb">
              <div className="work-thumb-inner thumb-dashboard">
                <div className="grid-lines"></div>
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" opacity="0.4">
                  <rect x="10" y="15" width="40" height="30" rx="3" stroke="#10b981" strokeWidth="1.5" />
                  <path d="M10 22h40M15 30h10M15 38h20" stroke="#10b981" strokeWidth="1" strokeLinecap="round" />
                </svg>
              </div>
              <div className="work-label label-full">Frontend</div>
            </div>
            <div className="work-body">
              <div className="work-title">Admin Dashboard</div>
              <div className="work-desc">An interactive administrative dashboard for data visualization and management.</div>
              <div className="work-stack">
                <span className="stack-tag">JavaScript</span>
              ...
              <div className="work-links">
                <Magnetic>
                  <a href="https://github.com/Hunny-785951/Admin-Dashboard" target="_blank" rel="noopener noreferrer" className="work-link">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="12" height="12"><path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" /></svg>
                    GitHub
                  </a>
                </Magnetic>
          ...
          <div className="work-card">
            <div className="work-thumb">
              <div className="work-thumb-inner thumb-portfolio-t">
                <div className="grid-lines"></div>
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" opacity="0.4">
                  <path d="M20 20h20M20 30h15M20 40h10" stroke="#f43f5e" strokeWidth="2" strokeLinecap="round" />
                </svg>
              </div>
              <div className="work-label label-full">Full Stack</div>
            </div>
            <div className="work-body">
              <div className="work-title">Job Portal</div>
              <div className="work-desc">A job platform connecting employers and job seekers with streamlined applications.</div>
              <div className="work-stack">
                <span className="stack-tag">JavaScript</span>
              ...
              <div className="work-links">
                <Magnetic>
                  <a href="https://github.com/Hunny-785951/Job_Portal" target="_blank" rel="noopener noreferrer" className="work-link">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="12" height="12"><path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" /></svg>
                    GitHub
                  </a>
                </Magnetic>
          ...
          <div className="work-card">
            <div className="work-thumb">
              <div className="work-thumb-inner thumb-task">
                <div className="grid-lines"></div>
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" opacity="0.4">
                  <circle cx="30" cy="30" r="15" stroke="#0ea5e9" strokeWidth="2" />
                  <path d="M30 20v10l7 7" stroke="#0ea5e9" strokeWidth="2" strokeLinecap="round" />
                </svg>
              </div>
              <div className="work-label label-full">Frontend</div>
            </div>
            <div className="work-body">
              <div className="work-title">Social Media Dashboard</div>
              <div className="work-desc">An analytics dashboard for social media tracking and engagement visualization.</div>
              <div className="work-stack">
                <span className="stack-tag">JavaScript</span>
                <span className="stack-tag">React</span>
              </div>
              <div className="work-links">
                <Magnetic>
                  <a href="https://github.com/Hunny-785951/Social_Media_Dashboard" target="_blank" rel="noopener noreferrer" className="work-link">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="12" height="12"><path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" /></svg>
                    GitHub
                  </a>
                </Magnetic>
